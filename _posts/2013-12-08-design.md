...
* reverting, which adds a previous state as a new state and the head becomes that;
* merging, which adds the latest state from another project as a new state and the head becomes that;
